...
describe("Users Table Endpoints", () => {
    describe("GET /api/users", () => {
        test("Returns all users", async () => {
            const result = await (0, supertest_1.default)(api_1.default).get("/api/users").expect(200);
        ...
        test("Return Single User by ID", async () => {
            const result = await (0, supertest_1.default)(api_1.default).get("/api/users/1").expect(200);
    ...
    describe("Post /api/users", () => {
        ...
        test("Login User as Member", async () => {
            ...
            await (0, supertest_1.default)(api_1.default).post("/api/auth/register").send(registerUser);
            const loginUser = {
                email: "testlogin@example.com",
                password: "Suhaim",
            };
...
describe("Event Table Endpoints", () => {
    describe("GET /api/events", () => {
        ...
        test("Return Single Event by ID", async () => {
            const result = await (0, supertest_1.default)(api_1.default).get("/api/events/1").expect(200);
